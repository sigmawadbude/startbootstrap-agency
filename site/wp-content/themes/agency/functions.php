...
function agency_scripts() {
	...
	wp_enqueue_style( 'agency-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '4.0.3', 'all' );
	...
	wp_enqueue_script( 'agency-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '20151215', true );

	wp_enqueue_script( 'agency-scripts.js', get_template_directory_uri() . '/assets/js/scripts.js', array('jquery'), '20151215', true );
